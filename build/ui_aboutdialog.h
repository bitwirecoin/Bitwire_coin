...
"Copyright &copy; 2011-YYYY The Bitwire developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bitwire", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Bitwire</b> version", 0));
